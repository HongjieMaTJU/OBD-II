...
#include <obd_protocol_inc/canhistory.h>
#include <obd_protocol_inc/isocan.h>
#include <obd_protocol_inc/obdprofile.h>
#include <utility_inc/canmsgbuffer.h>
 ...
 */
bool ISO15765_2::receiveFromEcu(bool sendReply)
{
