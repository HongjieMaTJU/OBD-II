 ...
 */
typedef struct {
	LPC_MRT_CH_Type CHANNEL[MRT_CHANNELS_NUM];
	uint32_t unused[45];
...
#define LPC_MRT_CH0         ((LPC_MRT_CH_Type *) &LPC_MRT->CHANNEL[0])
#define LPC_MRT_CH1         ((LPC_MRT_CH_Type *) &LPC_MRT->CHANNEL[1])
#define LPC_MRT_CH2         ((LPC_MRT_CH_Type *) &LPC_MRT->CHANNEL[2])
#define LPC_MRT_CH3         ((LPC_MRT_CH_Type *) &LPC_MRT->CHANNEL[3])
#define LPC_MRT_CH(ch)      ((LPC_MRT_CH_Type *) &LPC_MRT->CHANNEL[(ch)])
 ...
 */
STATIC INLINE LPC_MRT_CH_Type *Chip_MRT_GetRegPtr(uint8_t ch)
{
 ...
 */
STATIC INLINE uint32_t Chip_MRT_GetInterval(LPC_MRT_CH_Type *pMRT)
{
	return pMRT->INTVAL;
}
 ...
 */
STATIC INLINE void Chip_MRT_SetInterval(LPC_MRT_CH_Type *pMRT, uint32_t interval)
{
 ...
 */
STATIC INLINE uint32_t Chip_MRT_GetTimer(LPC_MRT_CH_Type *pMRT)
{
	return pMRT->TIMER;
}
 ...
 */
STATIC INLINE bool Chip_MRT_GetEnabled(LPC_MRT_CH_Type *pMRT)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_MRT_SetEnabled(LPC_MRT_CH_Type *pMRT)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_MRT_SetDisabled(LPC_MRT_CH_Type *pMRT)
{
	pMRT->CTRL &= ~MRT_CTRL_INTEN_MASK;
}
 ...
 */
STATIC INLINE MRT_MODE_T Chip_MRT_GetMode(LPC_MRT_CH_Type *pMRT)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_MRT_SetMode(LPC_MRT_CH_Type *pMRT, MRT_MODE_T mode)
{
	uint32_t reg;
 ...
 */
STATIC INLINE bool Chip_MRT_IsRepeatMode(LPC_MRT_CH_Type *pMRT)
{
 ...
 */
STATIC INLINE bool Chip_MRT_IsOneShotMode(LPC_MRT_CH_Type *pMRT)
{
 ...
 */
STATIC INLINE bool Chip_MRT_IntPending(LPC_MRT_CH_Type *pMRT)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_MRT_IntClear(LPC_MRT_CH_Type *pMRT)
{
 ...
 */
STATIC INLINE bool Chip_MRT_Running(LPC_MRT_CH_Type *pMRT)
{
